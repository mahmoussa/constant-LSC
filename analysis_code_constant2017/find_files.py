...
if __name__ == '__main__':
   constant_scan = ['X1', 'Y1']
   constant_run = {'X1': 300050, 'Y1': 300050}
   constant_ls_range = {'X1': [8, 60], 'Y1': [68, 122]} 
   constant_timestamp_range = {'X1': [1501261174, 1501262297], 'Y1': [1501262584, 1501263728]}

   #prefix = "root://eoscms//eos/cms"
   constant_dirListEOS = [
    '/eos/cms/store/group/comm_luminosity/ULReReco/09Aug2019_UL2017/6016/'+
    'ZeroBias1/crab_CMSSW_10_6_8_patch1_ZeroBias1_splitPerBXTrue/200414_025013/0000',
    '/eos/cms/store/group/comm_luminosity/ULReReco/09Aug2019_UL2017/6016/'+
    'ZeroBias1/crab_CMSSW_10_6_8_patch1_ZeroBias1_splitPerBXTrue/200414_035027/0000',
    '/eos/cms/store/group/comm_luminosity/ULReReco/09Aug2019_UL2017/6016/'+
    'ZeroBias2/crab_CMSSW_10_6_8_patch1_ZeroBias2_splitPerBXTrue/200414_025100/0000',
    '/eos/cms/store/group/comm_luminosity/ULReReco/09Aug2019_UL2017/6016/'+
    'ZeroBias3/crab_CMSSW_10_6_8_patch1_ZeroBias3_splitPerBXTrue/200414_025138/0000',
    '/eos/cms/store/group/comm_luminosity/ULReReco/09Aug2019_UL2017/6016/'+
    'ZeroBias4/crab_CMSSW_10_6_8_patch1_ZeroBias4_splitPerBXTrue/200414_025216/0000',
    '/eos/cms/store/group/comm_luminosity/ULReReco/09Aug2019_UL2017/6016/'+
    'ZeroBias5/crab_CMSSW_10_6_8_patch1_ZeroBias5_splitPerBXTrue/200414_025258/0000',
    '/eos/cms/store/group/comm_luminosity/ULReReco/09Aug2019_UL2017/6016/'+
    'ZeroBias6/crab_CMSSW_10_6_8_patch1_ZeroBias6_splitPerBXTrue/200414_025350/0000',
    '/eos/cms/store/group/comm_luminosity/ULReReco/09Aug2019_UL2017/6016/'+
    'ZeroBias6/crab_CMSSW_10_6_8_patch1_ZeroBias6_splitPerBXTrue/200414_035205/0000',
    '/eos/cms/store/group/comm_luminosity/ULReReco/09Aug2019_UL2017/6016/'+
    'ZeroBias7/crab_CMSSW_10_6_8_patch1_ZeroBias7_splitPerBXTrue/200414_025426/0000',
    '/eos/cms/store/group/comm_luminosity/ULReReco/09Aug2019_UL2017/6016/'+
    'ZeroBias7/crab_CMSSW_10_6_8_patch1_ZeroBias7_splitPerBXTrue/200414_035238/0000',
    '/eos/cms/store/group/comm_luminosity/ULReReco/09Aug2019_UL2017/6016/'+
    'ZeroBias8/crab_CMSSW_10_6_8_patch1_ZeroBias8_splitPerBXTrue/200414_025454/0000'
   ]
