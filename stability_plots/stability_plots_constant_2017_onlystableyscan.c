{
   TFile *f = new TFile ("/eos/home-m/mgadalla/LSC/stability_plots_2017/stability_plots_constant/stability_plots_constant_2017_onlystableyscan.root", "recreate");
  ...
  int stable_timestamp_begin_yscan[] = {1501262594,1501262718,1501262832,1501262949,1501263058,1501263198,1501263315,1501263434,1501263548,1501263660};
  int stable_timestamp_end_yscan[] = {1501262653,1501262770,1501262887,1501263004,1501263122,1501263259,1501263377,1501263493,1501263611,1501263712};
  ...
  */
  c1 -> Write();
  c1 -> SaveAs("/eos/home-m/mgadalla/LSC/stability_plots_2017/stability_plots_constant/stability_plots_constant_2017_yscan.pdf");
