{
   TFile *f = new TFile ("stability_plots_constant_2017_onlystablexscan.root", "recreate");
  ...
  c1->Divide(1,2);
  TProfile* ls_x = new TProfile("ls_x","Profile of vtx_x versus;lslumisection;mean vtx_x position(cm)",48,10,58,-0.900390,1.05613);
  ...
  int stable_timestamp_begin_xscan[] = {1501261177,1501261293,1501261409,1501261524,1501261639,1501261769,1501261884,1501261999,1501262114,1501262229};
  int stable_timestamp_end_xscan[] = {1501261247,1501261362,1501261477,1501261592,1501261707,1501261837,1501261952,1501262067,1501262182,1501262297};
